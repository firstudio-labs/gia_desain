                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="linkedin_perusahaan" class="form-control @error('linkedin_perusahaan') is-invalid @enderror" value="{{ old('linkedin_perusahaan', $profil->linkedin_perusahaan) }}" placeholder="Masukkan username Tiktok">
